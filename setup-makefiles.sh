...
mkdir -p ../../../vendor/samsung/epic

(cat << EOF) | sed s/__DEVICE__/epic/g > ../../../vendor/samsung/epic/epic-vendor.mk
# Copyright (C) 2010 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
(cat << EOF) | sed s/__DEVICE__/epic/g > ../../../vendor/samsung/epic/BoardConfigVendor.mk
# Copyright (C) 2010 The Android Open Source Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
(cat << EOF) | sed s/__DEVICE__/epic/g > ../../../vendor/samsung/epic/overlay/packages/apps/Launcher2/res/layout/all_apps.xml
